...
// GetInitParameters of this L2Connection
func (tr *L2Connection) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this L2Connection
func (tr *L2Connection) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
