...
// GetInitParameters of this L2ConnectionAccepter
func (tr *L2ConnectionAccepter) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this L2ConnectionAccepter
func (tr *L2ConnectionAccepter) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
